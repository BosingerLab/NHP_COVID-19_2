setwd("/yerkes-cifs/runs/Analysis/COVID_NHP_Study1/R4_10X_Seuratv4_v2/Lung")
...
data_path <- "/yerkes-cifs/runs/Analysis/COVID_NHP_Study1/R4_10X/GSE149758_Lung_control/"  
...
runQC <- function(path){
  ...
  counts <- Read10X_h5(paste0("/yerkes-cifs/runs/Analysis/COVID_NHP_Study1/R4_10X/GSE149758_Lung_control/",path))
