...
y_genes <- as.character(unlist(read.table("/yerkes-cifs/runs/Genome_references/macaca_mulatta/mmul10/ensembl_100/Y_genes.txt"),use.names = F))
mt_genes <-  as.character(unlist(read.table("/yerkes-cifs/runs/Genome_references/macaca_mulatta/mmul10/ensembl_100/MT_genes.txt"),use.names = F))
ig_genes <- as.character(unlist(read.table("/yerkes-cifs/runs/Genome_references/macaca_mulatta/mmul10/ensembl_100/IG_genes.txt"),use.names = F))
tr_genes <- as.character(unlist(read.table("/yerkes-cifs/runs/Genome_references/macaca_mulatta/mmul10/ensembl_100/TR_genes.txt"),use.names = F))
prot_coding <- as.character(unlist(read.table("/yerkes-cifs/runs/Genome_references/macaca_mulatta/mmul10/ensembl_100/protein_coding_seurat.txt"),use.names = F))
...
data_path <- "/yerkes-cifs/runs/Analysis/COVID_NHP_Study1/Data/10X/BAL"  
...
# list_obj2 <- readRDS("/yerkes-cifs/runs/Analysis/COVID_NHP_Study1/R4_10X/BAL/BAL_list_objects_all.rds")
